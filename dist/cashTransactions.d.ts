...
export declare function useCashTransactionsQuery(accountId: string, userId?: string | null): {
    _cleanup: () => void;
    data: import('vue').Ref<CashTransaction[], CashTransaction[]>;
    ...
    refetch: (options?: import('@tanstack/query-core').RefetchOptions) => Promise<import('@tanstack/query-core').QueryObserverResult<CashTransaction[], Error>>;
    fetchStatus: import('vue').Ref<import('@tanstack/query-core').FetchStatus, import('@tanstack/query-core').FetchStatus>;
    promise: import('vue').Ref<Promise<CashTransaction[]>, Promise<CashTransaction[]>>;
    suspense: () => Promise<import('@tanstack/query-core').QueryObserverResult<CashTransaction[], Error>>;
} | {
    _cleanup: () => void;
    data: import('vue').Ref<CashTransaction[], CashTransaction[]>;
