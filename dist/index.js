    ...
    queryFn: async () => {
      ...
      if (k.length === 0) {
        const { data: t, error: a } = await o.schema("hf").from("positions").select("internal_account_id").neq("internal_account_id", null).then((E) => {
          var m;
          return { data: ((m = E.data) == null ? void 0 : m.map((A) => A.internal_account_id)) ?? [], error: E.error };
        });
        if (a)
      ...
      const O = G.map((t) => {
        ...
        let m = null, A = null, j = null, P = null;
        if (t.asset_class === "STK" || t.asset_class === "FUND") {
          const l = p.get(t.conid);
          m = (l == null ? void 0 : l.price) || null, A = (l == null ? void 0 : l.fetchedAt) || null;
        } else if (t.asset_class === "OPT") {
          const l = p.get(t.conid), _ = p.get(t.undConid);
          j = (l == null ? void 0 : l.price) || null, P = (_ == null ? void 0 : _.price) || null, m = P, A = (_ == null ? void 0 : _.fetchedAt) || null;
        }
