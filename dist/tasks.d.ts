...
export declare function useTasksQuery(filters?: ComputedRef<{
    status?: string;
    search?: string;
}> | Ref<{
    status?: string;
...
export declare function useTaskQuery(id: string): import('@tanstack/vue-query').UseQueryReturnType<Task, Error>;
